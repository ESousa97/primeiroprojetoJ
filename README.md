...
![Pull Requests](https://img.shields.io/github/issues-pr/ESousa97/primeiroprojetoJ?style=for-the-badge)
![GitHub last commit](https://img.shields.io/github/last-commit/ESousa97/primeiroprojetoJ?style=for-the-badge)
![GitHub top language](https://img.shields.io/github/languages/top/ESousa97/primeiroprojetoJ?style=for-the-badge)
![GitHub code size in bytes](https://img.shields.io/github/languages/code-size/ESousa97/primeiroprojetoJ?style=for-the-badge)
![GitHub Issues](https://img.shields.io/github/issues/ESousa97/primeiroprojetoJ?style=for-the-badge)
![GitHub Contributors](https://img.shields.io/github/contributors/ESousa97/primeiroprojetoJ?style=for-the-badge)
![Build Status](https://img.shields.io/badge/build-passing-brightgreen?style=for-the-badge)
![License](https://img.shields.io/github/license/ESousa97/primeiroprojetoJ?style=for-the-badge)
...
* **`EstudosInterativo` (Módulo de Estudos/Anotações):** (Inferido) Provavelmente permite ao usuário inserir e visualizar anotações ou dicas de estudo pré-definidas. Pode demonstrar manipulação de strings, talvez armazenamento temporário em coleções simples.
...
idades Detalhadas (com Casos de Uso)
...
1. **Eclipse:** Vá em `File > Import... > Git > Projects from Git > Clone URI`. Cole a URL do repositório (`https://github.com/ESousa97/primeiroprojetoJ.git`). Siga os passos e importe como um "General Project" ou "Existing Projects into Workspace" e então configure-o como um projeto Java.
...
não requer dependências externas além do JDK. A compilação e execução podem ser feitas diretamente pela IDE ou via linha de comando.
...
1. **Navegue até o diretório do projeto:**
   ...
   ```bash
   cd primeiroprojetoJ-master/src
   ```
2. **Compile os arquivos `.java`:**

   ```bash
   javac main/java/main/java/*.java
   ```
...
Você pode relatar bugs ou sugerir novas funcionalidades abrindo uma "Issue" no repositório GitHub do projeto: [https://github.com/ESousa97/primeiroprojetoJ/issues](https://github.com/ESousa97/primeiroprojetoJ/issues).
...
* **Issues do GitHub:**
  ...
  * [Abrir uma nova Issue](https://github.com/ESousa97/primeiroprojetoJ/issues)
